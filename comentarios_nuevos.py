...
from functions.reemplazar_comentarios_nuevos import obtener_diccionario_raw_cur, reemplazar_por_comentarios_nuevos
...
df = pd.read_csv('data_consumo/metadata_hive_cdg.csv', sep='|', index_col=False)
path = ''
...
if __name__ == '__main__':
    ...
    try:
        df_metadata.to_csv('data_consumo/metadata_hive_cdg.csv', sep='|', index=False)
